  ...
  map = new google.maps.Map(
      ...
      console.log("FILTER() FILTERED")
        for(var i = 0; i < filteredStatus.length; i++)
            console.log("filter() " + filteredStatus[i])
        for(var i = 0; i < unfilteredStatus.length; i++)
            console.log("unfilter() " + unfilteredStatus[i])
  ...
  for (var i = 0; i < gmarkers.length; i++) 
    {
      ...
      if (filteredStatus[j] == gmarkers[i].category )
       { 
        ...
        console.log(gmarkers[i].category + "was filtered")
       }
...
console.log("i got in github repo")